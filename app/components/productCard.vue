<template>
  <div class="relative overflow-hidden rounded-lg shadow-sm bg-white hover:shadow-lg transition-shadow duration-300">
    <div class="relative product-card">
      ...
      <div
        v-if="product.tag"
        class="absolute top-3 right-3 bg-green-500 capitalize font-semibold text-white text-xs px-1 py-2 w-8 h-8 rounded-full z-20"
      >
        {{ product.tag }}
      </div>
     ...
     <div class="py-4 px-4">
      ...
      >
        ...
        <div class="flex gap-4 text-white text-sm">
          <span class="cursor-pointer hover:underline flex justify-center items-center gap-1"> <Share2/> Share </span>
          <span class="cursor-pointer hover:underline flex justify-center items-center gap-1"> <ArrowLeftRight/> Compare </span>
          <span class="cursor-pointer hover:underline flex justify-center items-center gap-1"> <Heart/> Like </span>
        </div>
      </div>
    </div>
